...
Amidst the hype of fancy UI design trends which continuously flood <a href="https://dribbble.com/search/neumorphism">Dribble</a>, the real question is how accessible are these designs? I myself gave in to this trend and experimented to create a toggle switch on <a href="https://codepen.io/tanisha03/pen/YzyGjeO">Codepen</a>.  With the outbreak of the craze around Neumorphism(New Skeuomorphism), designers are going crazy to replace the pre-existing designs over such new variations. 
...
If you look closely, while we increase the Contrast Loss for our <a href="https://chrome.google.com/webstore/detail/nocoffee/jjeeggmbnhckmgdhmgdckeigabjfbddl">NoCoffee Simulator</a>, the neumorphic components lose its shape and disappear while the text with better contrast ratio still remains visible. Therefore, the main problem with such a design is <strong>LOW Contrast Ratio</strong>. The usability of any application does not stand a chance until all people irrespective of their age and abiities can use the interface. Hence, people with Contrast Loss face so much trouble with this kind of design. Not only that, even  visually abled people using this application in bright sunlight may find difficulty in performing necessary actions owing to the soft shadows of the components. The main problem here is no clear demarcation between the background and UI components.

Another point to highlight is, this trend also causes problems for people with cognitive disabilities.

<img src="https://github.com/tanisha03/a11y-friendly/blob/master/src/images/neu2.jpg?raw=true" alt="crammed up neumorphic content" style="width:100%"/>
