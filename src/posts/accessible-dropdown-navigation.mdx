...
However, we obviously won't like a navigation something like this so let us just style it up. For the submenu, I have used <a href="https://css-tricks.com/places-its-tempting-to-use-display-none-but-dont/">visually-hidden</a> rather than display:none. I have omitted some general styling, you can have a look at the entire code <a href="https://github.com/tanisha03/a11y">here</a>.
...
Congratulations !!! You've your accessible navigation menu ready. Refer to the entire code <a href="https://github.com/tanisha03/a11y">here</a>.
