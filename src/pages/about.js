  ...
  return (
    <Layout>
      <p>
        ...
        great to have you onboard in this journey. I hope you're also trying to
        make web a better place for all by making it super accessible. Here is
        my little effort to do the same.
      </p>
      <br />
      <p>
        Accessibility is an often ignored topic when it comes to development. We
        fail to realize its impact but it and how great an affects it causes to
        ...
        . Hence, it is extremely essential to us to develop things that can
        seamlessly interact with all out users. Remember, ther web itself is
